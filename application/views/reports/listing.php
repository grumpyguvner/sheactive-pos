...
<ul id="report_list">
	...
	<li><h3><?php echo $this->lang->line('reports_inventory_reports'); ?></h3>
		<ul>
			<li><a href="<?php echo site_url('reports/specific_supplier');?>"><?php echo $this->lang->line('reports_stock_in_out'); ?></a></li>
			<li><a href="<?php echo site_url('reports/inventory_low');?>"><?php echo $this->lang->line('reports_low_inventory'); ?></a></li>
			<li><a href="<?php echo site_url('reports/inventory_valuation');?>"><?php echo $this->lang->line('reports_inventory_valuation'); ?></a></li>
