...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('employees_alt_login').':', 'password'); ?>
	<div class='form_field'>
	<?php echo form_password(array(
		'name'=>'alt_login',
		'id'=>'alt_login'
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('employees_login_page').':', 'login_page'); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'login_page',
		'id'=>'login_page',
		'value'=>$person_info->login_page));?>
	</div>
</div>
</fieldset>
