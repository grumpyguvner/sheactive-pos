...
<?php echo form_open('customerreturns/edit_item/'.$line,array('name'=>'capture_ean')); ?>
...
<?php echo form_input(array('id'=>'comment','name'=>'comment','value'=>$comment,'size'=>'30','style'=>'visibility:hidden;'));?>
