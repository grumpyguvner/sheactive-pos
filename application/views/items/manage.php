...
$(document).ready(function()
{
    ...
    $('#generate_barcodes_prices').click(function()
    {
    	var selected = get_selected_values();
    	if (selected.length == 0)
    	{
    	...
    	$(this).attr('href','index.php/items/generate_barcodes_prices/'+selected.join(','));
    });
...
<?php echo form_open("$controller_name/refresh",array('id'=>'add_plu_form')); ?>
...
<?php echo form_close() ?>
<?php echo form_open("$controller_name/refresh",array('id'=>'add_item_form')); ?>
<label id="item_label" for="item">
...
<?php echo form_close() ?>
<?php echo form_open("$controller_name/refresh",array('id'=>'find_by_location_form')); ?>
<label id="location_label" for="location">

<?php
	echo $this->lang->line('locations_location');
?>
</label>
<?php echo form_input(array('name'=>'location','id'=>'location','size'=>'40'),isset($location)?$location:"");?>
<?php echo form_close() ?>
...
<!--		<li class="float_left"><span><?php echo anchor("$controller_name/delete",$this->lang->line("common_delete"),array('id'=>'delete')); ?></span></li>
		...
		<li class="float_left"><span><?php echo anchor("$controller_name/generate_barcodes_prices",$this->lang->line("items_generate_barcodes_prices"),array('id'=>'generate_barcodes_prices', 'target' =>'_blank','title'=>$this->lang->line('items_generate_barcodes_prices'))); ?></span></li>
<!--		<li class="float_right">
		<img src='<?php echo base_url()?>images/spinner_small.gif' alt='spinner' id='spinner' />
                <?php echo form_input(array('name'=>'search','id'=>'search','value'=>isset($search)?  $search : "")); ?>
		</li> -->
	</ul>
</div>
		<?php echo form_close(); ?>
...
$(document).ready(function()
{
    ...
    $("#location").autocomplete('<?php echo site_url("locations/suggest"); ?>',
    {
    	minChars:0,
    	max:100,
    	selectFirst: false,
