...
$query=mysql_query("select * from pos_inventory where trans_items='" .$trans_items_id. "' ORDER BY trans_date DESC" );
...
<td><?php
	...
	$user=mysql_query("select * from pos_people where person_id='" .$person_id. "'");
