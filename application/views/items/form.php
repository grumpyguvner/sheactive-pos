...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_ean_upc').':', 'ean_upc',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'ean_upc',
		'id'=>'ean_upc',
		'value'=>$item_info->ean_upc)
	);?>
	</div>
</div>
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_supplierref').':', 'supplierref',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'supplierref'=>'supplierref',
		'id'=>'supplierref',
		'value'=>$item_info->supplierref)
	);?>
	</div>
</div>
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_retail_price').':', 'retail_price',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'retail_price',
		'size'=>'8',
...
<?php echo form_label($this->lang->line('items_location_ref').':', 'location',array('class'=>'wide')); ?>
	<div class='form_field'>
<!--	<?php echo form_dropdown('locations_ref', $locations, $selected_location);?> -->
	<?php echo form_input(array(
		'name'=>'location_ref',
		'id'=>'location_ref',
		'readonly' => 'readonly',
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_reorder_quantity').':', 'reorder_quantity',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
...
$(document).ready(function()
{
	...
	$('#item_form').validate({
		...
		messages:
		{
			...
			item_number:
			{
				required:"<?php echo $this->lang->line('items_item_number_required'); ?>",
				number:"<?php echo $this->lang->line('items_item_number_number'); ?>"
			},
			cost_price:
			{
			...
			retail_price:
			{
				required:"<?php echo $this->lang->line('items_retail_price_required'); ?>",
				number:"<?php echo $this->lang->line('items_retail_price_number'); ?>"
			},
			unit_price:
			{
			...
			reorder_quantity:
			{
				required:"<?php echo $this->lang->line('items_reorder_quantity_required'); ?>",
