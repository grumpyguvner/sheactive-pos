...
<?php echo form_open('sales/payment_save',array('name'=>'payment_save')); ?>
...
<tr>
    ...
    <td>
        <div class='bigger_button' id='payment_cash' style='float:right;margin-top:5px;' onclick="set_type('WEB')">
