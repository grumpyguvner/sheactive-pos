...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('config_address').' 1:', 'address1',array('class'=>'wide required')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'address1',
		'id'=>'address1',
		'value'=>$this->config->item('address1')));?>
	</div>
</div>

<div class="field_row clearfix">
<?php echo form_label($this->lang->line('config_address').' 2:', 'address2',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'address2',
		'id'=>'address2',
		'value'=>$this->config->item('address2')));?>
	</div>
</div>
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('common_vat_number').':', 'vat_number',array('class'=>'wide required')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'vat_number',
		'id'=>'vat_number',
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('common_return_policy').' 1:', 'return_policy1',array('class'=>'wide required')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'return_policy1',
		'id'=>'return_policy1',
		'value'=>$this->config->item('return_policy1')));?>
	</div>
</div>

<div class="field_row clearfix">
<?php echo form_label($this->lang->line('common_return_policy').' 2:', 'return_policy2',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'return_policy2',
		'id'=>'return_policy2',
		'value'=>$this->config->item('return_policy2')));?>
	</div>
</div>

<div class="field_row clearfix">
<?php echo form_label($this->lang->line('common_return_policy').' 3:', 'return_policy3',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'return_policy3',
		'id'=>'return_policy3',
		'value'=>$this->config->item('return_policy3')));?>
	</div>
</div>

<div class="field_row clearfix">
<?php echo form_label($this->lang->line('common_return_policy').' 4:', 'return_policy4',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'return_policy4',
		'id'=>'return_policy4',
		'value'=>$this->config->item('return_policy4')));?>
	</div>
</div>
...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('config_print_after_sale').':', 'print_after_sale',array('class'=>'wide required')); ?>
	<div class='form_field'>
	<?php echo form_dropdown('print_after_sale', array(
		'NONE'  => 'No Report',
		'RECEIPT'    => 'Print Sales Receipt',
		'REPORT'   => 'Print Sales Report'), $this->config->item('print_after_sale'));
		?>
	</div>
</div>
...
$(document).ready(function()
{
	$('#config_form').validate({
		...
		rules: 
		{
    		...
    		email:"email",
    		return_policy1: "required",
    		vat_number: "required"
   		},
		messages: 
		{
     		company: "<?php echo $this->lang->line('config_company_required'); ?>",
     		address1: "<?php echo $this->lang->line('config_address_required'); ?>",
     		...
     		default_tax_rate:
    		{
     		...
     		return_policy1:"<?php echo $this->lang->line('config_return_policy_required'); ?>",
     		vat_number:"<?php echo $this->lang->line('config_vat_number_required'); ?>"
