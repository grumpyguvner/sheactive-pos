...
<?php echo form_open('receivings/edit_item/'.$line,array('name'=>'capture_ean')); ?>
...
<?php echo form_input(array('id'=>'discount_reason','name'=>'discount_reason','value'=>$discount_reason,'size'=>'20','style'=>'visibility:hidden;'));?>
<?php echo form_input(array('id'=>'location_id','name'=>'location_id','value'=>$location_id,'size'=>'10','style'=>'visibility:hidden;')); ?>
