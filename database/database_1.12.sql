...
UPDATE `pos_app_config` SET `value` = '1.12' WHERE `key` = 'version';
UPDATE `pos_headoffice` SET `value` = '1.12' WHERE `key` = 'ho_version';
...
('module_orders', 'module_orders_desc', 1, 'orders');
...
CREATE TABLE `pos_orders` (
  ...
  KEY `pos_orders_ho_update` (`ho_update`)
...
CREATE TABLE `pos_order_items` (
  ...
  `quantity_ordered` double(15,2) NOT NULL DEFAULT '0.00',
  ...
  KEY `item_id` (`item_id`),
  KEY `pos_orders_items_ho_update` (`ho_update`)
